...
<body class="login">
    ...
    <form method="POST">
        <div class="box1">
            ...
            <?php elseif(uniquePseudo($pdo, $_POST['nom'])): ?>
                <p style="color: red;">Le pseudo est déjà pris.</p>
            <?php endif ?>
            </br>

            <input class="boite" type="text" id="email" name="email" placeholder="E mail" required value="<?php echo isset($_POST['email']) ? $_POST['email'] : ''; ?>"></br>
            ...
            <?php elseif(uniqueEmail($pdo, $_POST['email'])): ?>
